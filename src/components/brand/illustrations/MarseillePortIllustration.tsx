    ...
    >
      <defs>
        ...
        <linearGradient id="marseille-sea" x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stopColor="#e8d5a8" stopOpacity="0.45" />
          <stop offset="100%" stopColor="#4a5530" stopOpacity="0.12" />
        </linearGradient>
      </defs>
      ...
      {/* Soleil */}
      <circle cx="600" cy="140" r="46" fill="#d4af6e" opacity="0.55" />
      <circle cx="600" cy="140" r="30" fill="#d4af6e" opacity="0.85" />
      ...
      <g stroke="#4a5530" strokeWidth="1.4" fill="none">
        <rect x="556" y="148" width="36" height="42" />
        <polygon points="556,148 574,128 592,148" fill="#4a5530" fillOpacity="0.25" />
        <rect x="568" y="108" width="12" height="22" />
        <line x1="574" y1="108" x2="574" y2="92" />
        <circle cx="574" cy="88" r="4" fill="#d4af6e" stroke="none" />
      </g>

      {/* Mer */}
      <rect x="0" y="300" width="800" height="150" fill="url(#marseille-sea)" />
      {/* Reflets */}
      <g stroke="#4a5530" strokeWidth="0.8" opacity="0.45">
      ...
      <g stroke="#1f2218" strokeWidth="1.4" fill="#f4ecdd">
        ...
        <path d="M170 304 L196 340 L170 340 Z" fill="#4a5530" fillOpacity="0.55" />
      </g>
      <g stroke="#1f2218" strokeWidth="1.4" fill="#f4ecdd">
        <path d="M300 372 Q340 362 400 372 L390 390 Q350 396 310 390 Z" />
        <line x1="350" y1="372" x2="350" y2="296" />
        <path d="M350 300 L380 348 L350 348 Z" fill="#d4af6e" fillOpacity="0.65" />
      </g>
      <g stroke="#1f2218" strokeWidth="1.4" fill="#f4ecdd">
        <path d="M480 386 Q520 376 580 386 L570 404 Q530 410 490 404 Z" />
        <line x1="530" y1="386" x2="530" y2="308" />
        <path d="M530 312 L558 360 L530 360 Z" fill="#4a5530" fillOpacity="0.55" />
      </g>
