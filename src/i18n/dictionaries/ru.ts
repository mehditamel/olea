...
const ru = {
  ...
  home: {
    metaTitle:
      "Maison Oléa — средиземноморский ресторан в Марселе, Кассисе и Вильнёв-Лубе",
    metaDescription:
      "Три средиземноморских дома, вдохновлённых Югом: искренняя кухня, солнечные террасы и тёплый приём в Марселе, Кассисе и Вильнёв-Лубе.",
  },
  maisonHero: {
    ariaSection: "Maison Oléa {nom}",
    itineraire: "Как добраться",
    heroAlt: "Дом Oléa {nom} и его средиземноморская атмосфера",
  },
  maisonGallery: {
    ambiance: "Атмосфера",
