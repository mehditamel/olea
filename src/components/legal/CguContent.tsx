 ...
 * Extrait de la page CGU pour garder chaque fichier sous la limite de
 * 300 lignes (cf. CLAUDE.md). Contenu juridique non traduit (`lang="fr"`).
 */
export function CguContent({ l }: { l: Locale }) {
  return (
    <section className="bg-brand-cream px-6 md:px-12 py-14 md:py-20" lang="fr">
      <article className="mx-auto max-w-3xl text-brand-ink text-[15px] md:text-base leading-[1.75]">
        ...
        <ul className="list-disc ps-6 mb-6 space-y-1">
          <li>
        ...
        <p className="mb-4">
          ...
          réservation ferme.{" "}
          <strong>Aucune table n&apos;est garantie</strong> à la simple
          réception du formulaire. La réservation n&apos;est effective
          qu&apos;après confirmation expresse de Maison Oléa, par e-mail ou
          par téléphone, dans la limite des disponibilités.
        </p>
        <p className="mb-6">
        ...
        <p className="mb-6">
          ...
          transmettre une demande d&apos;information en vue de privatiser tout
          ou partie d&apos;une maison. Le devis qui pourra lui être adressé
          par Maison Oléa à la suite de cette demande est un document
          ...
          modification de l&apos;événement seront définies au cas par cas dans
          le devis signé.
        </p>
        ...
        <p className="mb-6">
          ...
          <strong>
            Aucune transaction monétaire n&apos;est conclue via le Site.
          </strong>{" "}
          Le règlement s&apos;effectue exclusivement sur place ou, pour les
          événements privatisés, selon les modalités précisées dans le devis
          signé.
        </p>
